...
export default function BeforeAfterDoor({
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-[280px] sm:max-w-[340px] md:max-w-[420px] aspect-[3/4] select-none touch-none cursor-ew-resize overflow-hidden shadow-2xl mx-auto"
